...
using static ImfuyoRanch.Models.RegisterViewModel;
using Shopping;
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> RegisterEmployee(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                employee.EmployeeSurname = model.Surname;
                employee.EmployeeEmail = model.Email;
                employee.Address = model.Address;
                employee.ContactNumber = model.ContactNumber;
                employee.ManagerEmail = userName;
                ...
                if (result.Succeeded)
                {
                    ...
                    mailTo.Add(new MailAddress(model.Email, model.Name));
                    var body = $"Hello {model.Name}, Imfuyo Ranch has created an account on your behalf as an Employee. <br/><br/>Your login credentials are as follows<br/><br/>" +
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                manager.ManagerName = model.Name;
                manager.ManagerSurname = model.Surname;
                manager.Email = model.Email;
                manager.Address = model.Address;
                manager.ContactNmber = model.ContactNumber;
        ...
        public async Task<ActionResult> RegisterCustomer(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                customer.phone = model.ContactNumber;
